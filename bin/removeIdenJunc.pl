...
# do blast search
my @blastout = `./blastall -p blastp -i $in -d data/db3/UP000005640_9606_additional_cdhit1.fasta -m8 -b1`;
my %hash = ();
foreach(@blastout){
	chomp;
...
my @proteom = `cat data/db3/UP000005640_9606_additional_cdhit1.fasta`;
open OUT, ">$out";
